...
VALUES
    ...
    ('Organic', 'Biodegradable wasteDTO such as food scraps, yard wasteDTO, and paper towels.', CURRENT_TIMESTAMP ),
    ...
    ('E-wasteDTO', 'Electronic wasteDTO such as old computers, mobile phones, and batteries.', CURRENT_TIMESTAMP );
...
VALUES
    ...
    ('Fruit Peels', 'Organic wasteDTO from fruits such as bananas, apples, and oranges.', 2, CURRENT_TIMESTAMP ),
    ('Grass Clippings', 'Organic yard wasteDTO from mowing the lawn.', 2, CURRENT_TIMESTAMP) ,
    ...
    ('Laptop Battery', 'An electronic wasteDTO item that must be disposed of responsibly.', 5, CURRENT_TIMESTAMP );
...
VALUES
    ...
    (9, 'E-Waste Disposal', 'Bring to an authorized e-wasteDTO recycling facility.', 'E-Waste Recycling Facility', CURRENT_TIMESTAMP),
    (10, 'Special Collection', 'Drop off at a hazardous wasteDTO collection site.', 'Hazardous Waste Center', CURRENT_TIMESTAMP);
